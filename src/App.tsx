...
function App() {
  ...
  const processFile = async () => {
    ...
    try {
      ...
      const validPoints = parsedPoints.filter(point => 
        typeof point === 'object' && 
        point !== null && 
      ...
      setProcessingError(error instanceof Error ? error.message : 'Unbekannter Fehler bei der Verarbeitung');
    } finally {
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Geben Sie Ihren Gemini API-Schlüssel ein</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <Button onClick={saveApiKey} className="w-full">Speichern</Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Definieren Sie die Bedeutung der Achsen</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="grid w-full items-center gap-1.5">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Anpassung der Linienverbindungen</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label htmlFor="lineStyle">Linienstil</Label>
                  <Select value={lineStyle} onValueChange={(value) => setLineStyle(value as 'eckig' | 'gerundet')}>
      ...
      <div className="mt-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Laden Sie Dateien hoch oder importieren Sie vorhandene Daten</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="upload">
              ...
              <TabsContent value="upload" className="space-y-4 mt-4">
                ...
                {!apiKey && <p className="text-sm text-red-500">Bitte geben Sie zuerst einen API-Schlüssel ein</p>}
                {processingError && <p className="text-sm text-red-500">Fehler: {processingError}</p>}
              </TabsContent>
